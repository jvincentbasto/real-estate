...
const Applications = () => {
  ...
  return (
    <div className="dashboard-container">
      ...
      >
        <TabsList className="grid w-full grid-cols-4 min-h-[60px]">
          <TabsTrigger value="all" className="cursor-pointer h-full">All</TabsTrigger>
          <TabsTrigger value="pending" className="cursor-pointer h-full">Pending</TabsTrigger>
          <TabsTrigger value="approved" className="cursor-pointer h-full">Approved</TabsTrigger>
          <TabsTrigger value="denied" className="cursor-pointer h-full">Denied</TabsTrigger>
        </TabsList>
        {tabs.map((tab) => (
