...
// methods
const insertLocationData = (locations) => __awaiter(void 0, void 0, void 0, function* () {
    for (const location of locations) {
      ...
      `;
            ...
            console.error(`Error inserting location for ${city}:`, error === null || error === void 0 ? void 0 : error.message);
        }
    }
});
const resetSequence = (modelName) => __awaiter(void 0, void 0, void 0, function* () {
...
const deleteAllData = (orderedFileNames) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const modelName of modelNames.reverse()) {
        ...
        try {
            ...
            console.error(`Error clearing data from ${modelName}:`, error === null || error === void 0 ? void 0 : error.message);
        }
    }
});
    ...
    for (const fileName of orderedFileNames) {
        ...
        if (modelName === "Location") {
            ...
            try {
                ...
                console.error(`Error seeding data for ${modelName}:`, error === null || error === void 0 ? void 0 : error.message);
            }
        }
